...
function Employees() {
    ...
    const deleteHandler = (employee_id) => {
        try {
            baseURL({
                method: "DELETE",
                url: `/api/v1/employee/delete/${employee_id}`,
            })
                .then(res => {
                        ...
                        <TableBody>
                            {employee.map((item) => (
                                <TableRow key={item.employee_id}>
                                    ...
                                    <TableCell>
                                        <div className="table__button" style={{ justifyContent: 'space-evenly' }} >
                                            <Link to='/update_employee' state={{
                                            ...
                                            <Popconfirm
                                                ...
                                                onConfirm={() => { deleteHandler(item.employee_id) }}
                                                okText="Yes"
                                                cancelText="No"
                                            >
