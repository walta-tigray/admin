...
// ant design icons
import { UserOutlined, UsergroupAddOutlined, MenuUnfoldOutlined, MenuFoldOutlined } from '@ant-design/icons'
                        ...
                        <Box style={{
                            ...
                            >
                                <div style={{
                                    ...
                                    <p>{decoded != null ? decoded.user.first_name + ' ' + decoded.user.last_name : ''} : <strong>{decoded != null ? decoded.userType : ''}</strong> </p>
